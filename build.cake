...
Parameters["SolutionName"] = "Orc.Serialization";
...
Components.Add("Orc.Serialization.Json");
Components.Add("Orc.Serialization.Yaml");

TestProjects.Add("Orc.Serialization.Json.Tests");
TestProjects.Add("Orc.Serialization.Yaml.Tests");
